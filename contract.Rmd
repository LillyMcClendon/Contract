...
-   [ ] `r advdate(dayone, 8, topic)`
    ...
    -   Finish portfolio piece 3 by `r startweek`: `r advdate(dayone, 12, assignment=startweek)`
-   [ ] `r advdate(dayone, 9, topic)`
    -   Finish Lab 9 by `r startweek`: `r advdate(dayone, 12, assignment=startweek)`
    -   Finish portfolio piece 4 by `r startweek`: `r advdate(dayone, 12, assignment=startweek)`
-   [ ] `r advdate(dayone, 10, topic)`
    -   Finish Lab 10 by `r startweek`: `r advdate(dayone, 12, assignment=startweek)`
-   [ ] `r advdate(dayone, 11, topic)` `r if(params$labs>=11) paste0(" - Finish Lab 11 by ",startweek,": ",advdate(dayone, 12, assignment=startweek))`
    -   Finish portfolio piece 5 by `r startweek`: `r advdate(dayone, 12, assignment=startweek)`
-   [ ] `r advdate(dayone, 12, topic)` `r if(params$labs>=12) paste0(" - Finish Lab 12 by ",startweek,": ",advdate(dayone, 12, assignment=startweek))`
