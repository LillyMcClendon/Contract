...
topic = c(
  ...
  "Scientific Communication confounding",
...
-   [ ] `r advdate(dayone, 8, topic)`
    -   Finish Lab 8 by `r startweek`: `r advdate(dayone, 12, assignment=startweek)`
    -   Finish portfolio piece 3 by `r startweek`: `r advdate(dayone, 13, assignment=startweek)`
-   [ ] `r advdate(dayone, 9, topic)`
    -   Finish Lab 9 by `r startweek`: `r advdate(dayone, 13, assignment=startweek)`
    -   Finish portfolio piece 4 by `r startweek`: `r advdate(dayone, 13, assignment=startweek)`
-   [ ] `r advdate(dayone, 10, topic)`
    -   Finish Lab 10 by `r startweek`: `r advdate(dayone, 13, assignment=startweek)`
-   [ ] `r advdate(dayone, 13, topic)` `r if(params$labs>=11) paste0(" - Finish Lab 11 by ",startweek,": ",advdate(dayone, 13, assignment=startweek))`
    -   Finish portfolio piece 5 by `r startweek`: `r advdate(dayone, 13, assignment=startweek)`
-   [ ] `r advdate(dayone, 13, topic)` `r if(params$labs>=13) paste0(" - Finish Lab 12 by ",startweek,": ",advdate(dayone, 13, assignment=startweek))`
    -   Finish portfolio piece 6 by `r startweek`: `r advdate(dayone, 13, assignment=startweek)`
-   [ ] `r advdate(dayone, 13, topic)` `r if(params$labs>=13) paste0(" - Finish Lab 13 by ",startweek,": ",advdate(dayone, 13, assignment=startweek))`
