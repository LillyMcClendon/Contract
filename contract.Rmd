...
-   [ ] `r advdate(dayone, 8, topic)`
    ...
    -   Finish portfolio piece 3 by `r startweek`: `r advdate(dayone, 14, assignment=startweek)`
-   [ ] `r advdate(dayone, 9, topic)`
    -   Finish Lab 9 by `r startweek`: `r advdate(dayone, 13, assignment=startweek)`
    -   Finish portfolio piece 4 by `r startweek`: `r advdate(dayone, 14, assignment=startweek)`
...
-   [ ] `r advdate(dayone, 13, topic)` 
    ...
    -   Finish portfolio piece 5 by `r startweek`: `r advdate(dayone, 15, assignment=startweek)`
-   [ ] `r advdate(dayone, 13, topic)` `r if(params$labs>=13) paste0(" - Finish Lab 12 by ",startweek,": ",advdate(dayone, 13, assignment=startweek))`
    -   Finish portfolio piece 6 by `r startweek`: `r advdate(dayone, 15, assignment=startweek)`
